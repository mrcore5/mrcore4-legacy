...
if (! function_exists('API\snippet')) {
    ...
    function snippet($name)
    {
        ...
        $file = base_path()."/vendor/mrcore/mrcore4-legacy/Legacy/$name.php";
    ...
    class v1_View
    {
        public function appmode($value = null)
        {
        ...
        public function form_attributes($value)
        {
            /*GLOBAL $view;
            if (isset($value)) {
        ...
        public function js($value = null, $append = true)
        {
            return Layout::js($value, $append);
        }

        public function remove_js($value)
        {
            return Layout::removeJs($value);
        }

        public function css($value = null, $append = true)
        {
            return Layout::css($value, $prepend);
        }

        public function css_print($value, $append = true)
        {
            return Layout::printCss($value, $prepend);
        }

        public function remove_css($value)
        {
    ...
    class v1_Page
    {
        ...
        public function get_url($page='', $is_user_image=false)
        {
